...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    for course in courses {
        table.add_row(row![
            ...
            course.term_desc.unwrap_or_default(),
            course.course_reference_number.unwrap_or_default(),
            course.part_of_term.unwrap_or_default(),
            course.course_number.unwrap_or_default(),
            course.subject.unwrap_or_default(),
            course.subject_description.unwrap_or_default(),
            course.sequence_number.unwrap_or_default(),
            course.campus_description.unwrap_or_default(),
            course.schedule_type_description.unwrap_or_default(),
            course.course_title.unwrap_or_default(),
            course
                .credit_hours
                .map_or("".to_string(), |v| v.to_string()),
            course
            ...
            course
                .wait_available
                .map_or("".to_string(), |v| v.to_string()),
            course.cross_list.unwrap_or_default(),
            course
                .cross_list_capacity
                .map_or("".to_string(), |v| v.to_string()),
            course
            ...
            course
                .credit_hour_low
                .map_or("".to_string(), |v| v.to_string()),
            course.credit_hour_indicator.unwrap_or_default(),
            course
                .open_section
                .map_or("".to_string(), |v| v.to_string()),
            course.link_identifier.unwrap_or_default(),
            course
                .is_section_linked
                .map_or("".to_string(), |v| v.to_string()),
            course.subject_course.unwrap_or_default(),
            course.instructional_method.unwrap_or_default(),
            course.instructional_method_description.unwrap_or_default(),
        ]);
    }
